...
<main class="admin-page">
  <div class="container">
    ...
    <div class="admin-card" style="margin-top:24px;" id="ticketStatsSection">
      ...
      <div id="ticketStatsBody" data-mgr-ajax-list>
        <%@ include file="/WEB-INF/views/manager/reports-ticket-partial.jsp" %>
      </div>
    </div>
