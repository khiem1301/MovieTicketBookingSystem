...
| File | Vai trò |
|------|---------|
| `WEB-INF/views/common/header.jsp` | Menu dropdown ADMIN: Dashboard, Quản lý user |
...
### 12.2 Menu Admin trong `header.jsp`
...
> Header cũng hiện link Manager (phim, thể loại) cho ADMIN — nhưng `RoleFilter` chặn ADMIN vào `/manager/*` (xem mục 14).
...
*Tài liệu chi tiết module Admin — cập nhật 08/06/2026.*
