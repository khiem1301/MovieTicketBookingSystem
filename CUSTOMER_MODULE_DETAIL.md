...
| Lịch sử đặt vé | FR-15 | `/booking-history` | ✅ |
...
| `/booking-history`, `/loyalty`, `/reviews/mine` | **CUSTOMER** + đăng nhập | `/booking-history` ✅ · loyalty/reviews chưa có |
...
| 4 | FR-15 | `BookingHistoryServlet` → `/booking-history` ✅ |
