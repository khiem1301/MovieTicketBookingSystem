...
| Thống kê | Số lượng |
|----------|----------|
| File Java (`src/main/java`) | **71** |
| Servlet đã triển khai | **22** |
| DAO | **9** |
| Entity | **9** |
| DTO | **4** |
| Filter | **3** |
...
5. **~16/26 bảng** chưa có lớp DAO tương ứng — chỉ schema + seed.
6. **Không có test tự động** — JUnit dependency có nhưng chưa viết test.
